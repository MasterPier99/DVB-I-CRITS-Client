...
window.onload = function(){
 ...
 //      $("#pause a").text("Pause");
	...
	var videoHLS = video;
	var config_hls={
	manifestLoadingTimeOut: 1000, // used by playlist-loader
    manifestLoadingMaxRetry: 8, // used by playlist-loader
	...
	player.addUTCTimingSource("urn:mpeg:dash:utc:http-xsdate:2014",UTC_TIME_SOURCE);
